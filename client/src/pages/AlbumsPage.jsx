            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {albums.map((album) => (
                <article key={album.id} className="overflow-hidden rounded-3xl border border-white/10 bg-[#111114]">
                  <div className={`flex h-32 items-end bg-gradient-to-br ${album.accent} p-4`}>
                    <div className="h-14 w-14 rounded-2xl border border-white/20 bg-white/10 backdrop-blur" />
                  </div>
                  <div className="p-5">
